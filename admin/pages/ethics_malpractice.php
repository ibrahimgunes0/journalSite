...
$pageId = db::query_fetch_column("SELECT page_id FROM page_settings WHERE page_name='ethics_malpractice'");
$sendState = $pageId > 0 ? "edit" : "save";
$page = db::query_fetch_assoc("SELECT * FROM page_settings WHERE page_id='".$pageId."'");
$header = "Etik ve Yanlış Uygulama";
$pageName = "ethics_malpractice";
